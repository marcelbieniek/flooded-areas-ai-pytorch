...
class UNet3plus():
    def __init__(self, num_classes: int = 10, input_shape=[3, 299, 299], deep_supervision=False, cgm=False):
        ...
        self.model = UNet3PlusImpl(input_shape, num_classes, deep_supervision, cgm, self.training)
...
def unet3plus(num_classes):
    return UNet3plus(num_classes)


# source: https://github.com/russel0719/UNet-3-Plus-Pytorch/blob/main/models/unet3plus.py
...
#     unet_3P = UNet3PlusImpl(INPUT_SHAPE, OUTPUT_CHANNELS, deep_supervision=False, cgm=False, training=True)
#     unet_3P_deep_sup = UNet3PlusImpl(INPUT_SHAPE, OUTPUT_CHANNELS, deep_supervision=True, cgm=False, training=True)
#     unet_3P_deep_sup_cgm = UNet3PlusImpl(INPUT_SHAPE, OUTPUT_CHANNELS, deep_supervision=True, cgm=True, training=True)
#     # print(unet_3P)
